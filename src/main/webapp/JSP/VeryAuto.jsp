...
<script language="javascript">
	...
	function addtasklist(orgcode, OrgName) {
		...
		var url = "OperatorAutoDealer.jsp?" + escape(new Date()) + "&OrgName="
...
<body style="text-align: center">
	...
	<hr>
	<div
		style="position: fixed; _position: absolute; top: 10px; right: 1px; _bottom: auto; _top: expression(eval(document.documentElement.scrollTop +50)); padding: 1px; z-index: 9999999; width: 100px; height: 30px;"
		class="p-t_10">
			...
			<table border="0" cellspacing="0">
				...
				<tr>
					...
					<td class="td_con" align="center"><input type="button"
						onclick="addtasklist('<%=z[1]%>','<%=z[2]%>');" name="autoactor"
						id="autoactor" value="加入任务"></input></td>
				</tr>
				<%
					}
				%>
